    ...
    return (
        <div className="min-h-screen relative flex flex-col items-center justify-center p-1 overflow-hidden">
            ...
            <div className="absolute inset-0 z-0">
                <div
                    ...
                    style={{
                        background:
                            "linear-gradient(120deg, #e6f2e6, #c2e5cc, #a3d9b5, #8cd9b3, #a8edea, #c2f0f7, #e6f2e6)",
      ...
      `}</style>
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                <div
                    className="absolute top-6 left-6 text-4xl opacity-30 animate-bounce wiggle"
                    style={{ animationDelay: "0s" }}
                >
                    🎲
                </div>
                <div
                    className="absolute top-12 right-8 text-2xl opacity-25 animate-bounce"
                    style={{ animationDelay: "0.5s" }}
                >
                    ⭐
                </div>
                <div
                    className="absolute bottom-10 left-10 text-3xl opacity-30 animate-bounce"
                    style={{ animationDelay: "1s" }}
                >
                    🎊
                </div>
                <div
                    className="absolute bottom-16 right-6 text-xl opacity-25 animate-bounce wiggle"
                    style={{ animationDelay: "1.5s" }}
                >
                    🚀
                </div>
                <div
                    className="absolute top-1/2 left-4 text-2xl opacity-20 animate-bounce"
                    style={{ animationDelay: "2s" }}
                >
                    🎯
                </div>
                <div
                    className="absolute top-1/3 right-4 text-3xl opacity-25 animate-bounce"
                    style={{ animationDelay: "2.5s" }}
                >
                    🤝
                </div>
                <div
                    className="absolute top-1/4 left-1/4 text-xl opacity-20 animate-bounce wiggle"
                    style={{ animationDelay: "3s" }}
                >
                    😎
                </div>
                <div
                    className="absolute bottom-1/3 right-1/4 text-2xl opacity-25 animate-bounce"
                    style={{ animationDelay: "3.5s" }}
                >
                    🔥
                </div>
                <div
                    className="absolute top-3/4 left-1/3 text-lg opacity-20 animate-bounce"
                    style={{ animationDelay: "4s" }}
                >
                    💯
                </div>
                <div
                    className="absolute top-1/6 right-1/3 text-xl opacity-25 animate-bounce wiggle"
                    ...
                    >
                        {currentRoll ? (
                            ...
                            <div className="w-12 h-12 border-2 border-dashed border-white/50 rounded-xl flex items-center justify-center bg-white/10">
                                <span className="text-white/70 text-2xl animate-pulse">
                                    ❓
                                </span>
                            </div>
                        )}
